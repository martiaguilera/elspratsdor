...
$sql = "SELECT * FROM aliments WHERE tipus = 'Cereal' ORDER BY nom";//Mostra aliments de tipus cereals, per a les imatges.
...
<html lang="ca">
  <head>
    ...
    <meta name="description" content="Botiga online amb productes ecològics i artesans de la granja Els Prats d'Or - Cereals" />
    <title>Cereals - Els Prats d'Or</title>
  ...
  <body>
    ...
    <main>
      <section class="seccio_botiga">
        <div class="caixa">
          <h1 class="titol1">Cereals</h1>
          <p class="text_principal">Descobreix la nostra selecció de cereals cultivats de manera sostenible.</p>

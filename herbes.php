...
$sql = "SELECT * FROM aliments WHERE tipus = 'Herba' ORDER BY nom";
...
<html lang="ca">
  <head>
    ...
    <meta name="description" content="Botiga online amb productes ecològics i artesans de la granja Els Prats d'Or - Herbes" />
    <title>Herbes - Els Prats d'Or</title>
  ...
  <body>
    ...
    <main>
      <section class="seccio_botiga">
        <div class="caixa">
          <h1 class="titol1">Herbes</h1>
          <p class="text_principal">Descobreix la nostra selecció d'herbes cultivades de manera sostenible i amb respecte per la natura.</p>

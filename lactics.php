...
$sql = "SELECT * FROM aliments WHERE tipus = 'Làctics' ORDER BY nom";
...
<html lang="ca">
  <head>
    ...
    <meta name="description" content="Botiga online amb productes ecològics i artesans de la granja Els Prats d'Or - Làctics" />
    <title>Làctics - Els Prats d'Or</title>
  ...
  <body>
    ...
    <main>
      <section class="seccio_botiga">
        <div class="caixa">
          <h1 class="titol1">Làctics</h1>
          <p class="text_principal">Descobreix els nostres productes làctics artesanals elaborats amb llet fresca de la granja.</p>

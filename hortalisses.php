...
$sql = "SELECT * FROM aliments WHERE tipus = 'Hortalissa' ORDER BY nom";
...
<html lang="ca">
  <head>
    ...
    <meta name="description" content="Botiga online amb productes ecològics i artesans de la granja Els Prats d'Or - Hortalisses" />
    <title>Hortalisses - Els Prats d'Or</title>
  ...
  <body>
    ...
    <main>
      <section class="seccio_botiga">
        <div class="caixa">
          <h1 class="titol1">Hortalisses</h1>
          <p class="text_principal">Descobreix les nostres hortalisses fresques cultivades de manera sostenible.</p>

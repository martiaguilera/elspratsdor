...
$sql = "SELECT * FROM aliments WHERE tipus = 'Fruita' ORDER BY nom";
...
<html lang="ca">
  <head>
    ...
    <meta name="description" content="Botiga online amb productes ecològics i artesans de la granja Els Prats d'Or - Fruites" />
    <title>Fruites - Els Prats d'Or</title>
  ...
  <body>
    ...
    <main>
      <section class="seccio_botiga">
        <div class="caixa">
          <h1 class="titol1">Fruites</h1>
          <p class="text_principal">Descobreix les nostres fruites fresques de temporada cultivades de manera sostenible.</p>

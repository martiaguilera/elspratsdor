...
<html lang="ca">
  <head>
    ...
    <meta name="description" content="Mel natural de la granja Els Prats d'Or" />
    <title>Mel - Els Prats d'Or</title>
  ...
  <body>
    ...
    <main>
      <section class="seccio_botiga">
        <div class="caixa">
          <h1 class="titol1">Mel</h1>
          <p class="text_principal">Mel natural produïda a la nostra granja.</p>
        ...
        <div class="graella_productes">
          <div class="producte">
            <img src="imgbotiga/mel.png" alt="Mel" class="imatge_producte" />
            <h3>Mel</h3>
            <p class="descripcio_producte">Mel</p>
            <p class="preu">4.50€/pot</p>
            <button onclick="addToCart(21, 'Mel', 4.50)" class="boto_comprar">Afegir al carret</button>
          </div>
        </div>
      </section>
    </main>

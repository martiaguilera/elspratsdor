...
<html lang="ca">
  <head>
    ...
    <meta name="description" content="Productes avícoles frescos de la granja Els Prats d'Or" />
    <title>Productes Avícoles - Els Prats d'Or</title>
  ...
  <body>
    ...
    <main>
      <section class="seccio_botiga">
        <div class="caixa">
          <h1 class="titol1">Productes Avícoles</h1>
          <p class="text_principal">Ous frescos de gallines criades en llibertat.</p>
        ...
        <div class="graella_productes">
          <div class="producte">
            <img src="imgbotiga/Ous frescos.png" alt="Ous frescos" class="imatge_producte" />
            <h3>Ous frescos</h3>
            <p class="descripcio_producte">Avícola</p>
            <p class="preu">2.40€/dotzena</p>
            <button onclick="addToCart(20, 'Ous frescos', 2.40)" class="boto_comprar">Afegir al carret</button>
          </div>
        </div>
      </section>
    </main>
